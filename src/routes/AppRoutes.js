...
import JoinedConference from '../features/conferences/JoinedConference'
  ...
  if (email) {
    return (
      <Switch>
        ...
        <CustomRoute isPrivate={false} exact path="/Conferences/view/:id(\d+)" component={JoinedConference} /> 
